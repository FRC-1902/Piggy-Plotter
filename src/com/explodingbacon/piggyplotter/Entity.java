...
public class Entity {
    ...
    public void draw(Graphics2D g) {
        ...
        if (fill) {
            g.fillRect(Main.scaleUp(x), Main.scaleUp(y), Main.scaleUp(width), Main.scaleUp(height));
            g.setColor(oldColor);
        }
        g.drawRect(Main.scaleUp(x), Main.scaleUp(y), Main.scaleUp(width), Main.scaleUp(height));
        g.setColor(oldColor);
    }
